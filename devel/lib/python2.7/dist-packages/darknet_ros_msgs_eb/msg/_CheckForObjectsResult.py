...
"""autogenerated by genpy from darknet_ros_msgs_eb/CheckForObjectsResult.msg. Do not edit."""
import sys
...
class CheckForObjectsResult(genpy.Message):
  ...
  _type = "darknet_ros_msgs_eb/CheckForObjectsResult"
...
"""
  ...
  _slot_types = ['int16','darknet_ros_msgs_eb/BoundingBoxes']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.bounding_boxes is None:
        self.bounding_boxes = darknet_ros_msgs_eb.msg.BoundingBoxes()
    else:
      self.id = 0
      self.bounding_boxes = darknet_ros_msgs_eb.msg.BoundingBoxes()
