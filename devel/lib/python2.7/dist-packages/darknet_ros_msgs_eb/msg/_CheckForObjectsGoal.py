...
"""autogenerated by genpy from darknet_ros_msgs_eb/CheckForObjectsGoal.msg. Do not edit."""
import sys
...
class CheckForObjectsGoal(genpy.Message):
  _md5sum = "c2342f9acc4aac63fdd632073dd76c7d"
  _type = "darknet_ros_msgs_eb/CheckForObjectsGoal"
...
"""
  __slots__ = ['id','image']
  _slot_types = ['int16','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CheckForObjectsGoal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_h3I().pack(_x.id, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.image.header.seq, _x.image.header.stamp.secs, _x.image.header.stamp.nsecs,) = _get_struct_h3I().unpack(str[start:end])
      start = end
      end += 4
